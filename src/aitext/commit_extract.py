...
AI_COMMIT_INSTRUCTION = (
    ...
    "СТРОГО ЗАПРЕЩЕНО заменять код заглушками: «# ...», «# остальной код без изменений», "
    "«# rest of code», «// ...» — только полное содержимое файла.\n\n"
    "Если файл слишком большой и не помещается целиком — скажи об этом явно "
    "и попроси пользователя уточнить какую часть изменить.\n\n"
