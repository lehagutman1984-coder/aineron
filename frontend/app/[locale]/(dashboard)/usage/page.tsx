            ...
            <div className="rounded-[14px] border border-[rgba(13,13,13,0.10)] bg-white p-5">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-[15px]">
                  <thead>
                    <tr className="border-b border-[rgba(13,13,13,0.08)] text-start text-[13px] font-medium uppercase tracking-wide text-[rgba(13,13,13,0.45)]">
                      <th className="pb-2 pe-4">{t("modelColumn")}</th>
                      <th className="pb-2 pe-4 text-end">{t("requestsLabel")}</th>
                      <th className="pb-2 pe-4 text-end">{t("tokensLabel")}</th>
                      <th className="pb-2 text-end">{t("spentLabel")}</th>
                    </tr>
                  </thead>
                  <tbody>
                    {stats.by_model.map((row) => (
                      ...
                      >
                        <td className="py-2 pe-4 font-medium text-[#1A1A1A]">
                          <Link
                        ...
                        <td className="py-2 pe-4 text-end text-[rgba(13,13,13,0.65)]">
                          {row.requests.toLocaleString(locale)}
                        </td>
                        <td className="py-2 pe-4 text-end text-[rgba(13,13,13,0.65)]">
                          {row.total_tokens.toLocaleString(locale)}
                        </td>
                        <td className="py-2 text-end text-[rgba(13,13,13,0.65)]">
