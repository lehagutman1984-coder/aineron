      ...
      {entries.length > 0 && (
        <div className="overflow-hidden rounded-[14px] border border-[rgba(13,13,13,0.09)] dark:border-[rgba(255,255,255,0.08)]">
          <table className="w-full text-[15px]">
            <thead>
              <tr
                className="border-b border-[rgba(13,13,13,0.08)] text-start dark:border-[rgba(255,255,255,0.07)]"
              ...
              >
                ...
                <th className="px-4 py-3 text-end font-semibold text-[rgba(13,13,13,0.55)] dark:text-[rgba(236,236,236,0.45)]">
                  Elo
                </th>
                <th className="px-4 py-3 text-end font-semibold text-[rgba(13,13,13,0.55)] dark:text-[rgba(236,236,236,0.45)]">
                  {t("tableMatches")}
...
function ArenaRow({ entry, rank }: { entry: ArenaEntry; rank: number }) {
  ...
  return (
    ...
    >
      ...
      <td className="px-4 py-3 text-end font-mono font-semibold text-[#1A1A1A] dark:text-[#EDE8E3]">
        {entry.elo_rating.toFixed(0)}
      </td>
      <td className="px-4 py-3 text-end text-[rgba(13,13,13,0.50)] dark:text-[rgba(236,236,236,0.42)]">
        {entry.elo_matches}
      </td>
    </tr>
  );
