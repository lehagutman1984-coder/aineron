        ...
        >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="h-7 rounded-[7px] border border-[rgba(13,13,13,0.12)] bg-white ps-7 pe-3 text-[14px] text-[#1A1A1A] outline-none focus:border-[#D97757] dark:border-[rgba(255,255,255,0.12)] dark:bg-[#1c1c1f] dark:text-[#EDE8E3]"
            />
          </div>
        </div>
              ...
              {filtered.map((network) => {
                ...
                return (
                  <button
                    ...
                    className={[
                      "flex items-center gap-2.5 rounded-[10px] border px-3 py-2.5 text-start transition-all",
                      isSelected
  ...
  return (
    <div className={["flex flex-col", isWinner ? "ring-2 ring-inset ring-[#f4a017]" : ""].join(" ")}>
      ...
      >
        ...
        <span className="ms-2 shrink-0 rounded-full bg-[rgba(13,13,13,0.06)] px-2 py-0.5 text-[13px] text-[rgba(13,13,13,0.48)] dark:bg-[rgba(255,255,255,0.06)] dark:text-[rgba(236,236,236,0.40)]">
