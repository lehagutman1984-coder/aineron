    ...
    <>
      ...
      <div className="mb-5 relative max-w-sm">
        <input
          ...
          className="w-full rounded-[8px] border border-[rgba(13,13,13,0.15)] bg-white px-4 py-2.5 text-[14px] text-[#0d0d0d] placeholder-[rgba(13,13,13,0.38)] outline-none focus:border-[#f0a38a] focus:ring-2 focus:ring-[rgba(10,124,255,0.12)] transition-all"
        />
      </div>
    ...
    >
      <div className="flex items-start gap-3">
        {network.avatar ? (
          ...
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[10px] bg-[rgba(10,124,255,0.10)] text-[#f0a38a]">
        ...
        <div className="min-w-0">
          <p className="truncate text-[14px] font-semibold text-[#0d0d0d] group-hover:text-[#f0a38a] transition-colors">
            {network.name}
          </p>
