            ...
            <button
              ...
              className={[
                ...
                active === c.key
                  ...
                  : "border border-[rgba(13,13,13,0.12)] text-[rgba(13,13,13,0.60)] hover:border-[rgba(13,13,13,0.25)] hover:text-[#0d0d0d]",
              ].join(" ")}
            >
              <CIcon size={13} />
              {c.label}
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          >
            ...
            <div className="mb-4 rounded-[12px] bg-[rgba(10,124,255,0.07)] px-4 py-3 text-[13px] text-[#0d0d0d]">
              {current.prompt}
            </div>
