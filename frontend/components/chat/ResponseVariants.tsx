  ...
  return (
    <div className="mt-3 rounded-[12px] border border-[rgba(10,124,255,0.18)] bg-[rgba(10,124,255,0.03)]">
      ...
      <div className="flex items-center gap-0.5 border-b border-[rgba(10,124,255,0.12)] px-3 py-2">
        <Layers size={13} className="mr-1.5 shrink-0 text-[#f0a38a]" />
        <span className="mr-3 text-[11px] font-semibold uppercase tracking-wide text-[#f0a38a]">
          Варианты
        </span>
        {variants.map((v, i) => (
          <button
            ...
            className={[
              ...
              i === activeIndex
                ...
                : "text-[#5a6a85] hover:bg-[rgba(10,124,255,0.08)] hover:text-[#f0a38a]",
            ].join(" ")}
          >
            {v.label}
          </button>
