...
### 7.4 Knowledge graph — `БЕСПЛАТНО` — оценка: 1–1.5 нед — M
...
### 7.5 Model Arena с Elo-рейтингом — `БЕСПЛАТНО` — оценка: 3–5 дней — S
...
### 7.7 Billing seats (посадочные места) — `БЕСПЛАТНО` — оценка: 3–5 дней — S
...
### 7.8 Zapier / Make интеграция — `БЕСПЛАТНО` — оценка: 2–4 дня — S
...
### 7.13 Telegram polls → AI-анализ — `БЕСПЛАТНО` — оценка: 2–3 дня — S
...
### 7.14 Scheduled AI reminders — `БЕСПЛАТНО` — оценка: 2–3 дня — S
