...
| Sprint | Фича | WOW | Конкур. разрыв закрывает | Стоимость |
|---|---|---|---|---|
| 1 | Img2Img + MediaAsset | 🔥🔥🔥 | Firefly / Flux Kontext | High (миграция) |
| 2 | Inpaint / Outpaint | 🔥🔥🔥 | Firefly | Medium |
| 3 | Img2Video + прогресс | 🔥🔥🔥 | Runway / Kling / Pika | Medium |
| 4 | Controls + История | 🔥🔥 | Midjourney | Low-Medium (форвардинг + config) |
| 5 | Enhancer + Compare | 🔥🔥 | Firefly / Leonardo | Low |
| 6 | Upscale + Variations + Ref | 🔥🔥 | Midjourney / Magnific | Medium |
| 7 | Галерея + API + надёжность | 🔥 | рост / SEO / SLA | Medium |
